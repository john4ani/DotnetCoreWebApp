...
namespace DotnetCoreWebApp.Migrations
{
    ...
    [Migration("20200615074018_OrdersDetails")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DotnetCoreWebApp.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("DotnetCoreWebApp.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("DotnetCoreWebApp.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("DotnetCoreWebApp.Models.Pie", b =>
                {
                    b.Property<int>("PieId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DotnetCoreWebApp.Models.ShoppingCartItem", b =>
                {
            ...
            modelBuilder.Entity("DotnetCoreWebApp.Models.OrderDetail", b =>
                {
                    b.HasOne("DotnetCoreWebApp.Models.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("DotnetCoreWebApp.Models.Pie", "Pie")
                        .WithMany()
                        .HasForeignKey("PieId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("DotnetCoreWebApp.Models.Pie", b =>
                {
                    b.HasOne("DotnetCoreWebApp.Models.Category", "Category")
                        .WithMany("Pies")
